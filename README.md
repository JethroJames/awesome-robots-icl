...
Papers accompanying **Robot In-Context Learning: Methods and Applications**, organized by the survey taxonomy. Each work appears once under its primary category.

English · [简体中文](README_zh-CN.md)

Newest first within each category. Links use arXiv where available, otherwise the publication or official report. `—` indicates that an official code repository has not been verified.

## Contents

- [Method families](#methods)
    - [Context-conditioned policies](#policy)
    - [Geometric demonstration transfer](#geometry)
    - [World-model-based control](#world)
    - [Skill- and agent-based execution](#agent)
- [Shared correspondence and memory mechanisms](#shared)
- [Data and acquisition interfaces](#data)
- [Training and improvement](#training)
- [Grounding and failure assessment](#grounding)
- [Benchmarks and evaluation](#evaluation)
- [Foundations and related surveys](#foundations)

<a id="methods"></a>

## Method families

The four families follow the execution interface from context to behavior. Pretraining, parameter adaptation, and self-improvement studies are grouped with their corresponding interface for comparison.
...
## Grounding and failure assessment
