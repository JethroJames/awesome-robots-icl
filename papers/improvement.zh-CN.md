...
[← 分类首页](../README_zh-CN.md) · [English](improvement.md)

按反馈改变的对象组织。S5「物理递归自我改进」关注后续任务中学习或验证流程的改进。

[交互上下文](#context) · [可执行产物](#artifacts) · [神经网络组件](#parameters) · [学习与验证流程](#acquisition)
...
| DrEureka: Language Model Guided Sim-To-Real Transfer <!-- paper:ma2024dreureka --> | <a href="https://arxiv.org/abs/2406.01967"><img src="https://img.shields.io/badge/arXiv-b31b1b.svg?style=flat-square" alt="arXiv" height="24"></a> | [代码 ↗](https://github.com/eureka-research/DrEureka) |
| Eureka: Human-Level Reward Design via Coding Large Language Models <!-- paper:ma2023eureka --> | <a href="https://arxiv.org/abs/2310.12931"><img src="https://img.shields.io/badge/arXiv-b31b1b.svg?style=flat-square" alt="arXiv" height="24"></a> | [代码 ↗](https://github.com/eureka-research/Eureka) |
